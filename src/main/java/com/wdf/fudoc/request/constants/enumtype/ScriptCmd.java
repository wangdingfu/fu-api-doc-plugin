...
public enum ScriptCmd {
    ...
    DOC("", FuBundle.message("fudoc.script.study.demo.doc"), FuColor.GITHUB.color(), ScriptCmdType.DEMO, true),
    ...
    PROJECT_GET_HEADER("code_get_header.js", FuBundle.message("fudoc.script.study.get.header"), FuColor.color3.color(), ScriptCmdType.SCRIPT_DEMO, false),
    ...
    CONSOLE_USERINFO("console.userInfo('这是一条{}级别日志','用户');", FuBundle.message("fudoc.script.console.userInfo.title"), FuColor.console_user_info.color(), ScriptCmdType.LOG, false),
    CONSOLE_VERBOSE("console.verbose('这是一条{}级别日志','verbose');", FuBundle.message("fudoc.script.console.verbose.title"), FuColor.console_verbose.color(), ScriptCmdType.LOG, false),
    CONSOLE_DEBUG("console.debug('这是一条{}级别日志','debug');", FuBundle.message("fudoc.script.console.debug.title"), FuColor.console_debug.color(), ScriptCmdType.LOG, false),
    ;
